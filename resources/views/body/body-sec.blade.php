<body class="impx-body" id="top">
		...
		<!-- SLIDESHOW -->
		@include('body.partials.slide-show')
		<!-- SLIDESHOW END -->

		<!-- SERVICES LIST & BOOKING FORM -->
		@include('body.partials.service')
		<!-- SERVICES LIST & BOOKING FORM END -->

		<!-- ROOMS LIST -->
		@include('body.partials.room-list')
		<!-- ROOMS LIST END -->

		<!-- WHY CHOOSE US? -->
		@include('body.partials.choose-us')
		<!-- WHY CHOOSE US? END -->

		<!-- PRICING PLANS -->
		@include('body.partials.pricing')
		<!-- PRICING PLANS END -->

		<!-- TESTIMONIALS CAROUSEL -->
		@include('body.partials.testimony')
